...
package com.example.amgad.movies_sn;
        ...
        import com.example.amgad.movies_sn.users;
        import com.example.amgad.movies_sn.posts;
        import com.example.amgad.movies_sn.comments;
        import com.example.amgad.movies_sn.friends;
        import com.example.amgad.movies_sn.movies;
...
//    @GET("/v/users/{userID}/rooms/{roomName}")
    @GET("/user/find/{id}")
    void find(@Path("id") int id, Callback<String> callback);


        @GET("/user/findFriends")
        void findFriends( Callback<users> callback);
